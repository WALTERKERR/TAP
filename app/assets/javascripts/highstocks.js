...
(function(J, ea) {
    ...
    yb.prototype = {
        ...
        run: function(a, b, c) {
            ...
            if (e() && Ra.push(e) === 1) e.timerId = setInterval(function() {
                for (f =
                    0; f < Ra.length; f++) Ra[f]() || Ra.splice(f--, 1);
    ...
    Y.prototype["stroke-widthSetter"] = Y.prototype.strokeSetter = function(a, b, c) {
        this[b] = a;
        if (this.stroke && this["stroke-width"]) this.strokeWidth = this["stroke-width"], Y.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]),
            this.hasStroke = !0;
    ...
    xa.prototype = {
        ...
        init: function(a, b, c, d, e, f) {
            ...
            this.boxWrapper = d;
            this.alignedObjects = [];
            this.url = (Za || tb) && B.getElementsByTagName("base").length ? J.location.href.replace(/#.*?$/,
        ...
        buildText: function(a) {
            ...
            !f && !o && !q && e.indexOf(" ") === -1 ? b.appendChild(B.createTextNode(v(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, A && A.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] ===
                            ...
                            if (e !== " ") {
                                ...
                                if (l) {
                                    for (var o = e.replace(/([^\^])-/g, "$1- ").split(" "), p = g.length > 1 || f || o.length > 1 && k.whiteSpace !== "nowrap", x, n, t, u = [], s = T(r), y = 1, w = a.rotation, C = e, z = C.length;
                                        (p || q) && (o.length || u.length);) a.rotation = 0, x = a.getBBox(!0), t = x.width, !ha && c.forExport && (t = c.measureSpanWidth(r.firstChild.data, a.styles)), x = t > l, n === void 0 && (n = x), q && n ? (z /= 2, C === "" || !x && z < 0.5 ? o = [] : (x && (n = !0), C = e.substring(0, C.length + (x ? -1 : 1) * Fa(z)), o = [C + (l > 3 ? "\u2026" :
                                        "")], r.removeChild(r.firstChild))) : !x || o.length === 1 ? (o = u, u = [], o.length && (y++, r = B.createElementNS(Qa, "tspan"), W(r, {
                                        dy: s,
                                        x: j
        ...
        symbol: function(a, b, c, d, e, f) {
            ...
            if (i) h = this.path(i), w(h, {
                ...
                a.element && (a.attr({
                    width: b[0],
                    height: b[1]
                }), a.alignByTranslate || a.translate(y((d -
                    b[0]) / 2), y((e - b[1]) / 2)))
            ...
            L = function() {
                ...
                if (z) {
                    if (!m) a = ja, b = (h ? -s : 0) + ja, k.box =
                        m = d ? j.symbol(d, a, b, k.width, k.height, Ua) : j.rect(a, b, k.width, k.height, 0, Ua["stroke-width"]), m.isImg || m.attr("fill", "none"), m.add(k);
                    m.isImg || m.attr(w({
                        width: y(k.width),
                        height: y(k.height)
                    }, Ua));
    ...
    if (!ha && !pa) Z = {
        ...
        Z.prototype.widthSetter = Z.prototype.heightSetter = Z.prototype.xSetter, Z = {
            Element: Z,
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, v =
                            'angle="' + (90 - X.atan((m - a) / (o - c)) * 180 / Ba) + '"', ja();
                        else {
                            var j = m.r,
                                Ua = j * 2,
                                t = j * 2,
                                ...
                                y = b.radialReference,
                                w, j = function() {
                                    y && (w = d.getBBox(), s += (y[0] - w.x) / w.width - 0.5, u += (y[1] - w.y) / w.height - 0.5, Ua *= y[2] / w.width, t *= y[2] / w.height);
                                    v = 'src="' + O.global.VMLRadialGradientURL + '" size="' + Ua + "," + t + '" origin="0.5,0.5" position="' + s + "," + u + '" color2="' + p + '" ';
                                    ja()
                                };
                            d.added ? j() : d.onAdd = j;
                            j = A
    ...
    db.prototype = {
        addLabel: function() {
            ...
            b = a.labelFormatter.call({
                ...
                value: a.isLog ? na(za(e)) : e
            });
            t(d) ? d && d.attr({
                text: b
            }) : (this.labelLength = (this.label = d = t(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(C(g.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0)
        },
        ...
        handleOverflow: function(a) {
            ...
            else if (d = c + (1 - i) * j, c - i * j < f ? k = a.x + k * (1 - i) - f : d > e && (k = e - a.x + k * i, l = -1), k = E(b.slotWidth, k), k < b.slotWidth && b.labelAlign === "center" && (a.x +=
                    l * (b.slotWidth - k - i * (b.slotWidth - E(j, k)))), j > k || b.autoRotation && g.styles.width) m = k;
            if (m) {
                o.width = m;
        ...
        render: function(a, b, c) {
            ...
            if (i && !isNaN(y)) i.xy = s = this.getLabelPosition(y, s, i, g, k, t, a, N), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel,
    ...
    F.prototype = {
        ...
        defaultLabelFormatter: function() {
            ...
            if (h) g = Ka(h, this);
                ...
                for (; f-- && g === u;) c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !== null && (g = z.numberFormat(b / c, -1) + e[f]);
            ...
            n(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        f = c.dataMax;
                        c = c.dataMin;
                        if (t(c) && t(f)) a.dataMin = E(p(a.dataMin,
                            c), c), a.dataMax = s(p(a.dataMax, f), f);
        ...
        translate: function(a, b, c, d, e, f) {
            ...
            b ? (a = a * h + i, a -= k, a = a / j + d, e && (a = g.lin2val(a))) : (e && (a = g.val2lin(a)), f === "between" && (f = 0.5), a = h * (a - d) * j + i + h * k + (ta(f) ? j * f * g.pointRange :
                0));
            return a
        },
        ...
        adjustForMinRange: function() {
            var a = this.options,
                ...
                f, g, h, i, j, k;
            if (this.isXAxis &&
                this.minRange === u && !this.isLog) t(a.min) || t(a.max) ? this.minRange = null : (n(this.series, function(a) {
                i = a.xData;
        ...
        setAxisTranslation: function(a) {
            ...
            if (k || i || d)
                if (h ? (f = h.minPointOffset, g = h.pointRangePadding) : (n(b.series, function(a) {
                    ...
                    g *= h, b.pointRange = E(d, c), k) b.closestPointRange = e;
            if (a) b.oldTransA = j;
        ...
        unsquish: function() {
            ...
            c ? (l = !b.staggerLines && !b.step && (t(h) ? [h] : f < p(b.autoRotationLimit, 80) && b.autoRotation)) && n(l, function(a) {
                var b;
                if (a === h || a && a >= -90 && a <= 90) j = m(Q(i.h / ia(oa * a))), b = j + Q(a / 360), b < k && (k = b, g = a, e = j)
            }) : b.step || (e = m(i.h));
            this.autoRotation = l;
        ...
        renderUnsquish: function() {
            ...
            if (this.autoRotation) n(c, function(a) {
                ...
                }), m > i && m > h.h ? j.rotation = this.labelRotation :
        ...
        getOffset: function() {
            ...
            if (j || a.isLinked) {
                if (n(e, function(b) {
                    ...
                    }), a.renderUnsquish(), r.reserveSpace !== !1 && (h ===
                        0 || h === 2 || {
                            1: "left",
                            3: "right"
        ...
        render: function() {
            var a = this,
                ...
                o = a.tickmarkOffset,
                q = d.lineWidth,
                r, A = b.hasRendered && t(a.oldMin) && !isNaN(a.oldMin),
                p = a.showAxis,
                v = c.globalAnimation,
                x, N;
            ...
            if (a.hasData() || f) {
                ...
                if (g.length && (n(g, function(b, c) {
                    ...
                    }), o && (a.min === 0 || a.single))) i[-1] || (i[-1] = new db(a, -1, null, !0)), i[-1].render(-1);
                m && n(g, function(c, d) {
                    N = g[d + 1] !== u ? g[d + 1] + o : a.max - o;
                    if (d % 2 === 0 && c < a.max && N <= a.max + (b.polar ? -o : o)) k[c] ||
                        (k[c] = new z.PlotLineOrBand(a)), x = c + o, k[c].options = {
                            from: e ? za(x) : x,
                            to: e ? za(N) : N,
                            color: m
        ...
        drawCrosshair: function(a, b) {
            ...
            else if (p(d.snap, !0) ? t(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ?
                a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null, c === null) this.hideCrosshair();
    ...
    F.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (t(b)) {
            ...
            h = i[kb]();
            for (var d = i.getTime(), l = i[jb](), m = i[ib](), o = !g || !!hb, q = (H.day + (g ? gb(i) : i.getTimezoneOffset() *
                    6E4)) % H.day; d < c;) e.push(d), j === H.year ? d = rb(h + b * k, 0) : j === H.month ? d = rb(h, l + b * k) : o && (j === H.day || j === H.week) ? d = rb(h, l, m + b * k * (j === H.day ? 1 : 7)) : d += j * k, b++;
            e.push(d);
            n(Sa(e, function(a) {
    ...
    F.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5) a = y(a), g = this.getLinearTickPositions(a, b, c);
            ...
            } else if (b = za(b), c = za(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = Bb(a, null, Ab(a)), g = sa(this.getLinearTickPositions(a, b, c), Na), !d) this._minorAutoInterval = a / 5;
    ...
    ab.prototype = {
        init: function(a, b) {
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (z.Tooltip && b.tooltip.enabled) a.tooltip = new Mb(a, b.tooltip), this.followTouchMove =
        ...
        runPointActions: function(a) {
            ...
            if (l[0] && (l[0] !== this.prevKDPoint || d && d.isHidden))
                ...
                g && g.tooltipOptions.followPointer, d && c && !d.isHidden && (c = d.getAnchor([{}], a), d.updatePosition({
                    plotX: c[0],
                    plotY: c[1]
                }));
        ...
        drag: function(a) {
            ...
            if (!m || !m.touch)
                if (d < h ? d = h : d > h + j && (d = h + j), e < i ? e = i : e > i + k && (e = i + k), this.hasDragged = Math.sqrt(Math.pow(o - d, 2) + Math.pow(q - e, 2)), this.hasDragged > 10) {
                    ...
                    if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !r && !m) this.selectionMarker = m = b.renderer.rect(h, i, f ? 1 : j, g ? 1 : k, 0).attr({
        ...
        onContainerClick: function(a) {
            ...
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (M(c.series, "click", w(a, {
                point: c
            })), b.hoverPoint && c.firePointEvent("click", a)) : (w(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY -
                e) && M(b, "click", a)))
        },
    ...
    if (J.PointerEvent || J.MSPointerEvent) {
        var Ga = {},
            ...
            bc = function() {
                ...
                for (a in Ga) Ga.hasOwnProperty(a) &&
                    b.push({
                        pageX: Ga[a].pageX,
                        pageY: Ga[a].pageY,
                        target: Ga[a].target
            ...
            Ob = function(a, b, c, d) {
                if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && $[ma]) d(a), d = $[ma].pointer, d[b]({
                    type: c,
    ...
    vb.prototype = {
        init: function(a, b) {
            ...
            if (b.enabled) c.itemStyle = d, c.itemHiddenStyle =
                C(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), D(c.chart, "endResize", function() {
        ...
        renderItem: function(a) {
            ...
            if (!A) {
                ...
                a.legendItem = A = c.text("", l ? f + g : -g, this.baseline || 0, x).css(C(a.visible ? h : i)).attr({
                    align: l ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup);
            ...
            if (e && this.itemX - r + f > (m || b.chartWidth - 2 * j - r - d.x)) this.itemX = r, this.itemY += q + this.lastLineHeight +
                o, this.lastLineHeight = 0;
        ...
        scroll: function(a, b) {
            var c = this.pages,
                ...
                j = this.padding;
            e > d && (e = d);
            if (e > 0) b !== u && cb(b, this.chart), this.nav.attr({
                    translateX: j,
    ...
    Ca.prototype = {
        ...
        initSeries: function(a) {
            ...
            (b = K[a.type || b.type || b.defaultSeriesType]) ||
            ea(17, !0);
            b = new b;
            b.init(this, a);
            return b
        ...
        getChartSize: function() {
            ...
            if (!t(b)) this.containerWidth = wa(c,
                "width");
        ...
        cloneRenderTo: function(a) {
            var b = this.renderToClone,
                c = this.container;
            a ? b && (this.renderTo.appendChild(c), Xa(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), I(b, {
                    position: "absolute",
                    top: "-9999px",
                    display: "block"
                }), b.style.setProperty &&
        ...
        setChartSize: function(a) {
            ...
            this.clipBox = {
                ...
                height: s(0, U(this.plotSizeY - s(d, h[2]) / 2 - c))
            };
        ...
        isReadyToRender: function() {
            var a = this;
            return !ha && J == J.top && B.readyState !== "complete" || pa && !J.canvg ? (pa ? Xb.push(function() {
                a.firstRender()
        ...
        splashArray: function(a, b) {
            var c = b[a],
                c = fa(c) ? c : [c, c, c, c];
            return [p(b[a + "Top"], c[0]), p(b[a + "Right"], c[1]), p(b[a + "Bottom"], c[2]), p(b[a + "Left"],
                c[3])]
        }
    };
    ...
    Ha.prototype = {
        ...
        applyOptions: function(a, b) {
            ...
            if (typeof this.x !== "number" && c) this.x = b === void 0 ? c.autoIncrement() :
                b;
            return this
        },
    ...
    P.prototype = {
        ...
        getAttribs: function() {
            ...
            if (!k || g < k || j)
                for (; g--;) {
                    k = i[g];
                    if ((c = k.options &&
                            k.options.marker || k.options) && c.enabled === !1) c.radius = 0;
                    if (r.length) {
                        j = 0;
        ...
        getGraphPath: function(a, b, c) {
            ...
            n(a, function(g, k) {
                ...
                g.isNull && !t(b) && k > 0 ? i = !e.connectNulls : g.isNull && !b ? i = !0 : (k === 0 || i ? o = ["M", g.plotX, g.plotY] : d.getPointSpline ? o = d.getPointSpline(a, g, k) : f ? (o = f === 1 ? ["L", o.plotX, m] : f === 2 ? ["L", (o.plotX + l) / 2, o.plotY, "L", (o.plotX + l) / 2, m] : ["L", l, o.plotY], o.push("L", l, m)) : o = ["L", l, m], h.push.apply(h, o), i = !1)
            });
    ...
    P.prototype.setStackedPoints = function() {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            ...
            for (v = 0; v < d; v++) {
                ...
                n = m[n][x];
                if (t !== null) n.points[T] = n.points[this.index] = [p(n.cum, g)],
                    n.touched = l.stacksTouched, q.index > 0 && this.singleStacks === !1 && (n.points[T][0] = n.points[this.index + "," + x + ",0"][0]);
                e === "percent" ? (r = r ? i : j, k && m[r] && m[r][x] ? (r = m[r][x], n.total = r.total = s(r.total, n.total) + Q(t) || 0) : n.total = na(n.total + (Q(t) || 0))) : n.total = na(n.total + (t || 0));
                n.cum = p(n.cum, g) + (t || 0);
    ...
    P.prototype.setPercentStacks = function() {
        ...
        n([b, "-" + b], function(b) {
            ...
            for (var g = d.length, h, i; g--;)
                if (h = d[g], e = a.getStackIndicator(e, h, a.index), f = (i = c[b] && c[b][h]) && i.points[e.key], h = f) i = i.total ? 100 / i.total : 0, h[0] = na(h[0] * i), h[1] = na(h[1] * i), a.stackedYData[g] = h[1]
        })
    };
    ...
    w(Ca.prototype, {
        ...
        showLoading: function(a) {
            ...
            if (!d) b.loadingDiv = d = ca(Ya, {
                ...
                ca("span", null, e.labelStyle, d), D(b, "redraw", f);
    ...
    w(Ha.prototype, {
        update: function(a, b, c, d) {
            function e() {
                f.applyOptions(a);
                if (f.y === null && h) f.graphic =
                    h.destroy();
                if (fa(a) && !Ma(a)) f.redraw = function() {
    ...
    var ya = ka(P, {
            ...
            if (this.options.stacking) {
                ...
                n(b, function(g, i) {
                    var o =
                        0,
                        p, v;
                    if (f[g] && !f[g].isNull) a.push(f[g]), n([-1, 1], function(a) {
        ...
        getGraphPath: function(a) {
            ...
            for (f = 0; f < a.length; f++)
                if (g =
                    a[f].isNull, k = p(a[f].rectPlotX, a[f].plotX), q = p(a[f].yBottom, o), !g || c) {
                    c || r(f, f - 1, "left");
    ...
    if (K.pie) K.pie.prototype.drawDataLabels = function() {
        ...
        }, K.pie.prototype.alignDataLabel = qa, K.pie.prototype.verifyDataLabelOverflow = function(a) {
            var b = this.center,
                c = this.options,
                d = c.center,
                e = c.minSize || 80,
        ...
        init: function() {
            ...
            a.mouseDownHandler = function(d) {
                var d = b.pointer.normalize(d),
                    ...
                    w, z = lb ? 10 : 7;
                if (y > h && y < h + g + k)
                    if ((h = !a.scrollbarEnabled || y < h + g) && X.abs(u - e - n) < z) a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null;
                    ...
                    if (f !==
                        e) a.fixedWidth = s, e = c.toFixedRange(f, f + s, null, w), d.setExtremes(e.min, e.max, !0, !1, {
                        trigger: "navigator"
                    })
                }
            };
    ...
    S(P.prototype, "addPoint", function(a, b, c, d, e) {
        ...
        f && this.xData.length > f && fa(b) && !Ma(b) && this.chart.scroller &&
            ea(20, !0);
        a.call(this, b, c, d, e)
    });
    w(O, {
    ...
    Jb.prototype = {
        ...
        updateButtonStates: function(a) {
            ...
            n(b.buttonOptions, function(a, e) {
                ...
                w || o && e !== h && e === b.lastSelected ? (b.setSelected(e), j[e].setState(2)) : !i && (t || s || v || u || z) ? j[e].setState(3) : j[e].state === 3 && j[e].setState(0)
            })
        },
    ...
    S(F.prototype, "getPlotLinePath", function(a, b, c, d, e, f) {
        ...
        w = g.isXAxis ? t(g.options.yAxis) ? [i.yAxis[g.options.yAxis]] : sa(h, function(a) {
                return a.yAxis
    ...
    S(ga, "getExtremes", function(a) {
        ...
        if (this.modifyValue) b = [this.modifyValue(this.dataMin), this.modifyValue(this.dataMax)], this.dataMin = Oa(b), this.dataMax = Ea(b)
    });
