    ...
    L.MarkerClusterGroup = L.FeatureGroup.extend({
            ...
            _defaultIconCreateFunction: function(t) {
                ...
                if (high_temp == false){
                  ...
                  var e = t.getChildCount(),
                      i = " marker-cluster-high-temp marker-cluster-";
                }
...
$(document).ready(function(){
  ...
  L.mapbox.accessToken = 'pk.eyJ1IjoiaG9saXhzZiIsImEiOiJjaWtzejBhZ3kwMDFqdXlrc2owcGlhdGc3In0.6ApbG1HxGWS2w_wQy6WwOQ';
  getMarkerData();
  mapClick();
...
var getMarkerData = function(){
  ...
  $.get('/data', 'json').done(function(data){
    ...
    marker.on('click', function(e){
      // global_city = this.options.city;
      // global_state = this.options.state;
      $('.sidebar-right').css('display', 'none');
      $('.mini-submenu-right').css('display', 'none');
