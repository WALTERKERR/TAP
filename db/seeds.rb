...
counter = 0
7.times do
  Datum.create(city: "San Francisco", state: "California", temp:94 + rand(0..5), time: Date.today - counter, humidity: 0.64 + rand(0.1..0.2), barometric_pressure: 30.17 + rand(0.1..1.5), ambient_temp: 65 + rand(0..15))
  counter += 1
  sleep(0.5)
end
